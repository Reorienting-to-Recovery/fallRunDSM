...
# initial params
r_to_r_max_flow_max_hab_params <- list(
  ...
  # DSMflow variables -----
  freeport_flows = DSMflow::freeport_flow$run_of_river,
  ...
  proportion_flow_bypass = DSMflow::proportion_flow_bypasses$run_of_river,
  gates_overtopped = DSMflow::gates_overtopped$run_of_river,
  ...
  degree_days = DSMtemperature::degree_days$run_of_river,
  mean_egg_temp_effect = DSMtemperature::egg_temperature_effect$fall_run,
  avg_temp = DSMtemperature::stream_temperature$run_of_river,
  ...
  spawning_habitat = DSMhabitat::fr_spawn$run_of_river_tmh,
  inchannel_habitat_fry = DSMhabitat::fr_fry$run_of_river_tmh, # vary by run
...
usethis::use_data(r_to_r_max_flow_max_hab_params, overwrite = TRUE)
