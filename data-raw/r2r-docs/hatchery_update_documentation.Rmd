...
2)  Percent natural is output from model in the `get_spawning_adults()` submodel (now split into multiple functions)
...
2) Percent natural is output from model after the adult enroute and harvest logic is applied
