...
4) Both natural adults and hatchery adults spawn.
...
For the baseline Recovery scenario we use an 75th percentile hatchery release value based on release data from all sources and years. (

### Adult return logic
#TODO update after talkin with rene
