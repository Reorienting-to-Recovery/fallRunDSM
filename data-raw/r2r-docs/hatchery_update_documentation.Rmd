...
1)  Each year, if model is run deterministicly, there are 307650 hatchery adults initiated into the model based on (CWT data?) - TODO add how it is split into tribs
...
5) Hatchery releases are added into the model logic in tributaries and when applicable as juveniles at chipps island. (tODO describe size)
