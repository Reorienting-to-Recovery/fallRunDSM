...
1)  Each year, if model is run deterministically, there are 307650 hatchery adults initiated into the model based on (CWT data?). Hatchery adults are split between tribs based on values from `fallRunDSM::hatchery_allocation`
...
hatchery_releases <- tibble(
  Hatchery = c("Coleman National Fish Hatchery", "Feather River Hatchery", "Merced River Fish Facility", "Nimbus Fish Hatchery", "Mokelumne Hatchery"),
  Tributary = c("Battle Creek", "Feather River", "Merced River", "American River", "Mokelumne River"),
  Run = c(rep("Fall", 5)),
  `Number Released` = c(12000000, # release in April 
                        6000000, 
                        1000000, # release April to mid may 
                        4000000, # released in the bay? 
                        5000000)) 
...
fall_hatchery_release<- array(rep(fall_hatchery_release, 20), 
                              c(31, 4, 20),
