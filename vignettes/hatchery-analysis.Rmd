...
`natural_adult_removal_rate` is used in the fallRunDSM by the `apply_enroute_survival()` function.  The number of `natural_adults_by_month` is determined by the binomial distribution with the probability equal to the `1 - natural_adult_removal_rate`. 
