...
- Updated to have fecundity vary by size of fish, [Roni and Quinn 1995](https://reorienting-to-recovery.s3.us-west-1.amazonaws.com/RoniandQuinn1995.pdf) logic was used to map fish age to size. Then we scaled fecundity by size using logic from [Malick et all 2023.](https://www.x-mol.net/paper/article/1664889742509719552)
...
This logic is pulled directly from Cyril Michel's paper: *Nonlinear survival of imperiled fish informs managed flows in a highly modified river* ([Cyril J. Michel, 2021](https://esajournals.onlinelibrary.wiley.com/doi/10.1002/ecs2.3498)).
...
requested by Russ Perry. All flow related data provided to the function is pulled from CalSim and processed in the DSMflow data package. All temperature related data provided to the function is processed in the DSMtemperature data package. 
